...
// const List_Slide = document.querySelectorAll('.portfolio__content')
...
//     document.querySelector('.portfolio__content.active').classList.remove('active')
//     List_Slide[index].classList.add('active')

// }

// const nextSlide = () => {
//     index_slide = index_slide + 1 === List_Slide.length ? 0 : index_slide + 1
//     showSlide(index_slide)
// }

// const prevSlide = () => {
//     index_slide = index_slide - 1 < 0 ? List_Slide.length - 1 : index_slide - 1
//     showSlide(index_slide)
// }
...
// setTimeout(() => {
//     List_Slide[0].classList.add('active')
// }, 200);
